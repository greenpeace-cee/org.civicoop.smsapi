 ...
 */
class CRM_Smsapi_Upgrader_Base {

  /**
   * @var CRM_Smsapi_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Smsapi_Upgrader(
        'org.civicoop.smsapi',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Smsapi_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Smsapi_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
